        ...
        window.openMathDrawer = function(targetId) {
            ...
            overlay.innerHTML = `
                <div style="background:white; padding:25px; border-radius:15px; width:95%; max-width:800px; direction:rtl; text-align:right;">
                    ...
                    <math-field id="drawer-field" style="width:100%; font-size:32px; border:2px solid #2d5a27; border-radius:10px; margin-bottom:20px; padding:15px;" virtual-keyboard-mode="onfocus"></math-field>
        ...
        function injectButtons() {
            document.querySelectorAll('.django-ckeditor-widget').forEach(widget => {
                ...
                if (!widget.querySelector('.math-draw-btn')) {
                    ...
                    btn.type = 'button';
                    btn.style = "margin: 10px 0; background:#2d5a27; color:white; padding:8px 20px; border-radius:25px; cursor:pointer; font-weight:bold; border:none;";
